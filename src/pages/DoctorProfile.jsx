            ...
            <div className='flex flex-col gap-4 m-5'>
                ...
                <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
                    ...
                    <div className='flex gap-1 pt-2'>
                        <input onChange={() => isEdit && setprofileData(prev => ({ ...prev, available: !prev.available }))} checked={profileData.available || false} type="checkbox" name=" " id=" " />
                        <label htmlFor=" ">Available</label>
                    </div>
                    {
                        isEdit
                            ? <button onClick={updateLocalProfile} className='px-4 py-1 border border-primary text-sm rounded-full mt-5 hover:bg-primary hover:text-white transition-all'>Save</button>
                            :
